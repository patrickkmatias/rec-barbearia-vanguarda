# 🔧 ATIVIDADE RECUPERATIVA: RESGATE DA BARBEARIA VANGUARDA
...
5. **📱 DICAS para GitHub + Vercel**
   - **GitHub:** Certifique-se de que o repositório é público para o Vercel acessar
   - **Vercel:** O deploy é automático - qualquer mudança no GitHub atualiza o site
   - **Teste sempre:** Depois de publicar, teste TUDO no link do Vercel
   - **Estrutura:** Os arquivos `index.html` e `style.css` devem estar na raiz do repositório
...
- `index-recuperacao.html` - Arquivo HTML com problemas
- `style-recuperacao.css` - Arquivo CSS com problemas  
- `public/` - Pasta com todas as imagens necessárias

### 🚀 PROCESSO DE ENTREGA

#### 1. **Corrija todos os problemas** nos arquivos fornecidos
- Trabalhe nos arquivos `index-recuperacao.html` e `style-recuperacao.css`
- **NÃO modifique** os arquivos da pasta `public/`

#### 2. **Renomeie os arquivos corrigidos** para:
- `index.html` (era `index-recuperacao.html`)
- `style.css` (era `style-recuperacao.css`)

#### 3. **Crie um repositório no GitHub**
- Acesse [github.com](https://github.com) e faça login
- Clique em "New repository" (novo repositório)
- Nome do repositório: `barbearia-vanguarda-recuperacao`
- Marque como **público**
...
- Arraste ou selecione os arquivos:
  - `index.html` (arquivo corrigido)
  - `style.css` (arquivo corrigido)
  - Toda a pasta `public/` com as imagens
- Escreva uma mensagem de commit: "Projeto Barbearia Vanguarda - Atividade Recuperativa"
- Clique em "Commit changes"

#### 5. **Publique no Vercel** 
- Acesse [vercel.com](https://vercel.com) e faça login com sua conta GitHub
- Clique em "New Project"
- Selecione o repositório `barbearia-vanguarda-recuperacao`
- Clique em "Import"
- **NÃO altere** as configurações - clique em "Deploy"
- Aguarde o deploy finalizar (aprox. 1-2 minutos)
- **Copie o link do site publicado** (ex: `https://barbearia-vanguarda-recuperacao.vercel.app`)

#### 6. **Teste o site publicado**
- Acesse o link do Vercel
- Verifique se **TUDO** está funcionando corretamente
- Menu, sliders, vídeo, responsividade, etc.

### 📋 ENTREGA FINAL
**Envie pelo formulário da atividade:**
1. **Link do repositório GitHub** (ex: `https://github.com/seu-usuario/barbearia-vanguarda-recuperacao`)
2. **Link do site no Vercel** (ex: `https://barbearia-vanguarda-recuperacao.vercel.app`)

### ✅ CRITÉRIOS DE ENTREGA
- [ ] Repositório GitHub criado e **público**
- [ ] Todos os arquivos commitados corretamente
- [ ] Site publicado no Vercel e **funcionando 100%**
- [ ] Links enviados no formulário

## ⏰ TEMPO SUGERIDO
- **3-4 horas** para identificar e corrigir todos os problemas (23 problemas no total)
- **30 minutos extras** para criar repositório GitHub e publicar no Vercel
...
2. **Depois vá para o CSS** (cores, layout, botões, erros de digitação)
3. **Continue com JavaScript** (funcionalidades interativas)
4. **Teste localmente** com Live Server antes de publicar
5. **Publique no GitHub + Vercel** e teste novamente online

## 🤝 AJUDA PERMITIDA
- ✅ Consultar documentação oficial (MDN, W3Schools)
- ✅ Usar ferramentas do desenvolvedor do navegador
- ✅ Consultar anotações de aula
- ✅ Documentação do GitHub e Vercel
...
### 🌟 BONUS: PORTFÓLIO
Esta atividade também te ensina a:
- **Usar GitHub** para versionar e compartilhar código
- **Publicar sites** no Vercel (usado por empresas reais!)
